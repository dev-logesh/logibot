...
from logibot import MONGO_DB_URI
...
def load_module(shortname):
    if shortname.startswith("__"):
        ...
        import importlib
        import logibot.events

        path = Path(f"logibot/modules/{shortname}.py")
        name = "logibot.modules.{}".format(shortname)
        ...
        spec.loader.exec_module(mod)
        sys.modules["logibot.modules." + shortname] = mod
        print("Successfully imported " + shortname)


path = "logibot/modules/*.py"
