...
from logibot.__main__ import STATS, TOKEN, USER_INFO
from logibot.modules.sql import SESSION
import logibot.modules.sql.userinfo_sql as sql
from logibot.modules.disable import DisableAbleCommandHandler
from logibot.modules.sql.global_bans_sql import is_user_gbanned
from logibot.modules.sql.afk_sql import is_afk, set_afk
from logibot.modules.sql.users_sql import get_user_num_chats
from logibot.modules.helper_funcs.chat_status import sudo_plus
from logibot.modules.helper_funcs.extraction import extract_user
...
def stats(update: Update, context: CallbackContext):
    stats = "<b>╔═━「 Current LOGI's Statistics 」</b>\n" + "\n".join([mod.__stats__() for mod in STATS])
